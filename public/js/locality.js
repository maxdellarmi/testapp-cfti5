	...
	/*markerLOC = new google.maps.Marker({
        ...
        if (ExportKml == "") {
            ...
            jQuery.get('/OtherFilesService/KML@locality_a.txt', function (data) {
                ...
                ExportKml = ExportKml + "<b>" + sLoctot + "</b><br><i>" + noteexp + "</i><br><br>Latitude: <b>" + locLat + "</b> <br>Longitude: <b>" + locLon + "</b> <br><br><b><a href=" + virg + "https://cfti.ingv.it:8003/locality.php?" + nloc + "EN" + virg + ">Locality page </a></b>" + CarRet;
