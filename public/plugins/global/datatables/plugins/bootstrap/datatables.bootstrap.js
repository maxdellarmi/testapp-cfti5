...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    "language": {
        "lengthMenu": " _MENU_ <h7 class='records_lang'>records</h7> ",
        "paginate": {
            "previous": "<h7 class='prev_lang'>Prev</h7>",
            "next": "<h7 class='next_lang'>Next</h7>",
            "page": "<h7 class='page_lang'>Page</h7>",
            "pageOf": "<h7 class='of_lang'>of</h7>"
        }
    },
...
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap_full_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                '<ul class="pagination">' +
                '<li class="prev disabled"><a href="#" title="' + oLang.sFirst + '"><i class="fa fa-angle-double-lef"></i></a></li>' +
...
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap_extended": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                '<div class="pagination-panel"> ' + (oLang.page ? '<h7 class="page_lang">Page</h7>' : '') + ' ' +
                ...
                (oLang.pageOf ? '<h7 class="page_of">of</h7>' + ' <span class="pagination-panel-total"></span>': '') +
                '</div>'
            );
